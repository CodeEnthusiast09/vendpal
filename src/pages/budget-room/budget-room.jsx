...
export const BudgetRoom = () => {
  ...
  return (
    <div className="lg:ml-[36.2%] xl:ml-[29.4%] 2xl:ml-[21.7%] lg:mt-7">
      <BudgetTabs />

      <div className="md:px-[24px] py-5 md:py-10 text-sm md:text-[20px] lg:text-lg xl:text-[20px] font-medium flex flex-col md:flex-row items-center gap-[16px] md:gap-[32px] border-b border-primary-300">
        <p>Financial year </p>
